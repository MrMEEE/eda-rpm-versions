...
%package -n     python%{python3_pkgversion}-priority
Summary:        %{summary}

%description -n python%{python3_pkgversion}-priority %_description
...
%files -n python%{python3_pkgversion}-priority -f %{pyproject_files}
