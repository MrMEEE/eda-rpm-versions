...
%pyproject_extras_subpkg -n python%{python3_pkgversion}-google-auth aiohttp,enterprise-cert,pyopenssl,reauth,requests
...
%pyproject_buildrequires -x aiohttp,enterprise-cert,pyopenssl,reauth,requests
