...
%package -n     python%{python3_pkgversion}-pydantic
Summary:        %{summary}

%description -n python%{python3_pkgversion}-pydantic %_description
...
%files -n python%{python3_pkgversion}-pydantic -f %{pyproject_files}
