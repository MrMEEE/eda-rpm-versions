...
%package -n     python%{python3_pkgversion}-types-setuptools
Summary:        %{summary}

%description -n python%{python3_pkgversion}-types-setuptools %_description
...
%files -n python%{python3_pkgversion}-types-setuptools -f %{pyproject_files}
