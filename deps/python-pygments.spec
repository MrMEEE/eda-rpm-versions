...
mv $RPM_BUILD_ROOT/usr/bin/pygmentize $RPM_BUILD_ROOT/usr/bin/pygmentize%{python3_pkgversion}
%endif
...
%if "%{python3_pkgversion}" != "3"
sed -i "s|/usr/bin/pygmentize|/usr/bin/pygmentize%{python3_pkgversion}|g" %{pyproject_files}
%endif
